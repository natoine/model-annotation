...
@XmlRootElement
public class Mood extends Tag
{
	public String toRDF(String _url_rdf_resource, String _rdf_toinsert)
	{
		String _rdf = "<jeu2debat:Mood rdf:about=\""+ _url_rdf_resource +"?id=" + getId() +"\" >" ;
		...
		_rdf = _rdf.concat("</jeu2debat:Mood>");
		return _rdf;
	}
	
	public String toSeeAlso(String _url_rdf_resource)
	{
		String rdf = "<jeu2debat:Mood rdf:about=\""+ _url_rdf_resource +"?id=" + getId() +"\" >" ;
		if(! _url_rdf_resource.equalsIgnoreCase(getRepresentsResource().getEffectiveURI()))
