...
public class Domain extends Tag
{
	...
	public Domain getFather() {
		return father;
	}

	public void setFather(Domain father) {
		this.father = father;
	}
	...
	public String toHTML()
	{
		...
		if(getFather()!=null) _html.concat("<div class=domain_father>Sous-domaine de : <a href=" + getFather().getRepresentsResource().getEffectiveURI() + "?id=" + getFather().getId() + ">" + getFather().getLabel() + "</a></div>");
		return _html;
	}
	...
	{
		String _rdf = "<jeu2debat:Domain rdf:about=\""+ _url_rdf_resource +"?id=" + getId() +"\" >" ;
		...
		_rdf = _rdf.concat("</jeu2debat:Domain>");
		return _rdf;
	}
	
	public String toSeeAlso(String _url_rdf_resource)
	{
		String rdf = "<jeu2debat:Domain rdf:about=\""+ _url_rdf_resource +"?id=" + getId() +"\" >" ;
		if(! _url_rdf_resource.equalsIgnoreCase(getRepresentsResource().getEffectiveURI()))
		...
		rdf = rdf.concat("</jeu2debat:Domain>");
		return rdf ;
	}
